...
python alpaca_lora/scripts/prepare_utils.py --manner split --alpaca-data $DATA/alpaca_data.json
...
python alpaca_lora/scripts/prepare_utils.py --manner replace --alpaca-data $DATA/alpaca_data.json
