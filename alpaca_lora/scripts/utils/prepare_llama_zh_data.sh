...
DATA=/opt/data/private/data/llama/belle
SPM=/opt/data/private/code/sentencepiece/build/src/spm_encode
MODEL=/opt/data/private/data/llama/tokenizer.model

python alpaca_lora/scripts/utils/prepare_utils.py --manner split_zh --alpaca-data $DATA/Belle.train.json
...
python alpaca_lora/scripts/utils/prepare_utils.py --manner replace_zh --alpaca-data $DATA/Belle.train.json
